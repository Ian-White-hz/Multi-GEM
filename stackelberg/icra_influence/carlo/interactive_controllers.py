...
class KeyboardController:
    def __init__(self, world):
        ...
        self.min_steering = -0.5 #-0.5
        self.max_steering = +0.5 #0.5
...
class SteeringWheelController: # For Logitech G29 Steering Wheel
    ...
    def steering(self):
        ...
        return -self.joystick.get_axis(0) * 0.5 # This is set for Logitech G29 with 50000 as autocenter. Use 0.25 for Joystick
    @property
    def throttle(self):
        events = pygame.event.get() # This is necessary
        return -self.joystick.get_axis(2) # 3 for gamepad, 1 for steering wheel (Mac), 2 for steering wheel (Ubuntu)
